...
String ru_from=new String(request.getParameter("ru_from").getBytes("ISO-8859-1"),"GB18030");
...
try {
	...
	// 删除信息的SQL语句
	String sql = "insert into yonghu(username,password,tel,l_name,l_ceng,l_wu,l_danyuan,ru_from,l_fangxing,beizhu,shijian)values('"+username+"','"+password+"','"+tel+"','"+l_name+"','"+l_ceng+"','"+l_wu+"','"+l_danyuan+"','"+ru_from+"','"+l_fangxing+"','"+beizhu+"','"+ShowTime.showTodayTime()+"')";
	// 获取PreparedStatement
